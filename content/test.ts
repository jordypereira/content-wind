...
head.image: 'timeline.png'
---

# Timeline

## 2023
_Transition to Lead Developer making sure all parts and people of the E-Commerce platform flow nicely together_
...
// Replace all <p> tags with empty strings
const withoutPTags = inputHtml.replace(/<p>.*?<\/p>/g, "");

// Replace all <img> tags with Markdown format
const withMarkdownImages = withoutPTags.replace(/<img[^>]*alt="([^"]*)"[^>]*>/g, "![$1]{alt=\"$1\"}");

console.log(withMarkdownImages);
